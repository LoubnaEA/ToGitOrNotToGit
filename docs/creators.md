...
This period saw the rise of public playhouses and the professionalization of playwrights.   
It explored moral, political and metaphysical transgression, from Elizabeth’s optimistic court to the darker post-Reformation stage.  

This **dataset** gathers major playwrights of the **English Renaissance (1558–1642)**, spanning the **Elizabethan**, **Jacobean** and **Caroline** periods.    
...
- **Number of core playwrights :** 20 (9 Elizabethan, 11 Jacobean + Caroline)  
...
✨ [creatures.md](https://github.com/LoubnaEA/ToGitOrNotToGit/blob/main/docs/creatures.md) → who acts   
